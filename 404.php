            ...
            <div class="col-12">
                <main id="primary" class="site-main">
                    ...
                    <section class="error-404 not-found text-center">
                        <svg id="robot" version="1.1" xmlns="http://www.w3.org/2000/svg"
                             xmlns:xlink="http://www.w3.org/1999/xlink" x="0" y="0" width="320px" height="300px"
                             viewBox="0 0 160 300" enable-background="new 0 0 320 300" xml:space="preserve">
    <rect x="59.722" y="72.779" fill="#333" width="40.557" height="27.564"/>
		...
		C75.85,13.604,65.745,3.39,53.972,3.39">
                                        <animate attributeName="d" calcMode="spline"
                                                 ...
                                                 dur="0.75s" repeatCount="indefinite" values="
		...
		C102.547,67.282,103.383,68.4,103.383,69.778z">
                                    <animate attributeName="d" calcMode="spline"
                                             keySplines="0.42 0 0.58 1; 0.42 0 0.58 1; 0.42 0 0.58 1" begin="0s"
                                             dur="1s" repeatCount="indefinite" values="
			...
			c0,3.526-2.859,6.386-6.387,6.386c-3.525,0-6.385-2.859-6.385-6.386V200.63L98.73,200.63L98.73,200.63z"/>
					...
					c-3.162,1.673-7.062,0.435-8.715-2.768C97.742,200.62,98.964,196.664,102.123,194.988z"/>
                        ...
                        <div class="col">
                            ...
                            <a href="<?php echo site_url(); ?>" class="btn btn-default mb-5">Go to Home</a>
                        </div>
                    </section><!-- .error-404 -->
